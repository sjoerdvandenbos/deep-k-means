...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--autoencoder", type=str.upper, default="CONVO_AUTOENCODER",
    ...
    parser.add_argument("--decoder_input", type=str.upper, default="MIXED_TEACHER_FORCING",
                        choices=["EMPTY", "RECURSIVE", "TEACHER_FORCING", "MIXED_TEACHER_FORCING"], nargs="?")
    parser.add_argument("--n_layers", type=int, default=2)
    parser.add_argument("--teacher_forcing_probability", type=float, default=0.)
    ...
    if args.decoder_input == "MIXED_TEACHER_FORCING":
        assert args.teacher_forcing_probability > 0, "Set a teacher forcing probability"

    # Autoencoder setup from arguments
    n_batches = int(ceil(specs.n_samples / args.batch_size)) * args["p-epochs"]
